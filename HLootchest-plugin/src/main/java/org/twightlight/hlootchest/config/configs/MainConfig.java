...
public class MainConfig extends YamlWrapper {
    ...
    public MainConfig(Plugin pl, String name, String dir) {
        ...
        yml.addDefault("database.password", "");
        yml.addDefault("database.ssl", false);

        yml.addDefault("database.redis.enabled", false);
        yml.addDefault("database.redis.host", "localhost");
        yml.addDefault("database.redis.port", 6379);
        yml.addDefault("database.redis.password", "");
