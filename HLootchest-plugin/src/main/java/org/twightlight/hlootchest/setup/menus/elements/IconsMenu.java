...
public class IconsMenu {
    ...
    private ClickableAction backAction;
    public IconsMenu(Player p, TConfigManager templateFile, String name, String path, SetupSessions session, boolean isChild, ClickableAction backAction) {
        this.p = p;
