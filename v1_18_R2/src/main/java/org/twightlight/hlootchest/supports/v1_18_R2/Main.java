package org.twightlight.hlootchest.supports.v1_18_R2;
...
public class Main extends NMSHandler {
    ...
    public void registerButtonClick(Player player) {
        ...
        nmsPlayer.b = (PlayerConnection)new ClickEvent(nmsPlayer.b.a, nmsPlayer);
    }
    ...
    public void playSound(Player player, Location location, String sound, float yaw, float pitch) {
        player.playSound(location,
                XSound.of(sound).get().get(), yaw, pitch);
    }
    ...
    public static float getPitch(Entity entity) {
        try {
            Method method = entity.getClass().getDeclaredMethod("do");
