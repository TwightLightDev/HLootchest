...
public class ColorUtils {
    ...
    public String colorize(String text, char colorSymbol) {
    ...
    public List<Character> charactersWithoutColors(String text) {
    ...
    public List<String> charactersWithColors(String text) {
        return charactersWithColors(text, '§');
    }

    public List<String> charactersWithColors(String text, char colorSymbol) {
    ...
    private String rgbGradient(String text, Color start, Color end, char colorSymbol) {
    ...
    private ChatColor fromColor(Color color) {
        try {
